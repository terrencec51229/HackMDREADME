...
:::info
###### tags: `AWS` `Networking` `NativeCloud` `HybridCloud` `VPCPeering` `TransitVPC` `TransitGateway` `DirectConnect`
:::
...
>*Since this post much focuses on the VPC-level solution rather than the Endpoint-level solution so that [PrivateLink](https://aws.amazon.com/blogs/aws/aws-privatelink-update-vpc-endpoints-for-your-own-applications-services/) is not covered here.*
...
![Direct Connect Gateway](https://i.imgur.com/4KWen2F.png)
